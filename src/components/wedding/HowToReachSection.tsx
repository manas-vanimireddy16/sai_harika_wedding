...
const HowToReachSection = () => {
    ...
    return (
        <section className="px-5 py-6">
            ...
            <div className="flex gap-2 mb-5">
                {tabs.map((t, i) => (
                    <button
                        ...
                        className={`flex-1 py-2.5 rounded-xl text-xs font-medium transition-all ${i === activeTab
            ...
            <AnimatedContainer className="space-y-3" key={activeTab}>
                {data.modes.map((mode) => {
                    const Icon = iconMap[mode.type];
                    return (
                        <AnimatedCard key={mode.label}>
